 ...
 *      
 * VersionOne:
 *      Initial attempt at getting a working solution without worrying about technical debt.
 *      Solution met the requirements.
 *      Does not allow user entries.
 *      
...
namespace OnlineGroceryStore
{
    ...
    {
        private class SharedFunctions
        {
            public int remainder;
            public int minimum;
            public int amount;

            public void FindOptimalPackaging()
            {
                SpecialCaseDivision();
                LargeDivision();
                FindOptimal();
            ...
            public virtual void LargeDivision()
            {

            }
            public virtual void SpecialCaseDivision()
            {

            }
            public virtual void FindOptimal()
            {
        ...
        //Data containers for the result
        private class SlicedHam : SharedFunctions
        {
            public int threePack;
            public int fivePack;

            public override void SpecialCaseDivision()
            {
                switch (remainder)
                {
                    case 3:
            ...
            public override void LargeDivision()
            {
                int dividesEvenly = remainder / 5;
                fivePack += dividesEvenly;
                remainder -= dividesEvenly * 5;
                //can reach minimum
                if (((fivePack * 5) + remainder) >= minimum)
                {
                    while (fivePack > 0 && remainder < minimum)
                    {
                        fivePack--;
                        remainder += 5;
                    }
                ...
                {
                    dividesEvenly = remainder / 3;
                    threePack += dividesEvenly;
                    remainder -= 3 * dividesEvenly;
                }
            }

            public override void FindOptimal()
            {
                //min of 8, max at 12
                switch (remainder)
                {
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        //Shouldnt reach this case, added for thoroughness
                        fivePack += 2;
                        threePack += 0;
                        remainder = 0;
                        break;
                    ...
                    default:
                        if (remainder < 8)
                        {
                            //Console.WriteLine("Single Items present, Either too few, or odd amount to divide evenly into packs");
                        }
                        else if (remainder > 12)
                        {
                            Console.WriteLine("RESULT ERROR: Exceeded maximum in FindOptimal()");
                        }
                        break;
                }
            }
            ...
            {
                double grossFigure = (threePack * 2.99) + (fivePack * 4.49);
                Console.WriteLine(amount + " SH3 $" + grossFigure);
                if (fivePack > 0)
                {
                    Console.WriteLine(" " + fivePack + " x 5 $4.49");
                }
                if (threePack > 0)
                {
                    Console.WriteLine(" " + threePack + " x 3 $2.99");
                }
                if (remainder > 0)
                {
                    Console.WriteLine(" " + remainder + " x 1");
        ...
        private class Yoghurt : SharedFunctions
        {
            public int fourPack;
            public int tenPack;
            public int fifteenPack;
            ...
            public override void LargeDivision()
            {
                int dividesEvenly = remainder / 15;
                fifteenPack += dividesEvenly;
                remainder -= dividesEvenly * 15;
                //can reach minimum
                if (((fifteenPack * 15) + remainder) >= minimum)
                {
                    while (fifteenPack > 0 && remainder < minimum)
                    {
                        fifteenPack--;
                        remainder += 15;
                    }
                ...
                {
                    dividesEvenly = remainder / 10;
                    tenPack += dividesEvenly;
                    remainder -= 10 * dividesEvenly;

                    dividesEvenly = remainder / 4;
                    fourPack += dividesEvenly;
                    remainder -= 4 * dividesEvenly;
                }
            }
            ...
            public override void PrintSolution()
            {
                double grossFigure = (fourPack * 4.95) + (tenPack * 9.95) + (fifteenPack * 13.95);
                Console.WriteLine(amount + " YT2 $" + grossFigure);
                if (fifteenPack > 0)
                {
                    Console.WriteLine(" " + fifteenPack + " x 15 $13.95");
                }
                if (tenPack > 0)
                {
                    Console.WriteLine(" " + tenPack + " x 10 $9.95");
                }
                if (fourPack > 0)
                {
                    Console.WriteLine(" " + fourPack + " x 4 $4.95");
                }
                if (remainder > 0)
                {
                    Console.WriteLine(" " + remainder + " x 1");
        ...
        private class ToiletRolls : SharedFunctions
        {
            public int threePack;
            public int fivePack;
            public int ninePack;
            ...
            public override void LargeDivision()
            {
                int dividesEvenly = remainder / 9;
                ninePack += dividesEvenly;
                remainder -= dividesEvenly * 9;
                //can reach minimum
                if (((ninePack * 9) + remainder) >= minimum)
                {
                    while (ninePack > 0 && remainder < minimum)
                    {
                        ninePack--;
                        remainder += 9;
                    }
                ...
                {
                    dividesEvenly = remainder / 5;
                    fivePack += dividesEvenly;
                    remainder -= 5 * dividesEvenly;
            ...
            public override void PrintSolution()
            {
                double grossFigure = (threePack * 2.95) + (fivePack * 4.45) + (ninePack * 7.99);
                Console.WriteLine(amount + " YT2 $" + grossFigure);
                if (ninePack > 0)
                {
                    Console.WriteLine(" " + ninePack + " x 9 $7.99");
                }
                if (fivePack > 0)
                {
                    Console.WriteLine(" " + fivePack + " x 5 $4.45");
                }
                if (threePack > 0)
                {
                    Console.WriteLine(" " + threePack + " x 3 $2.95");
                }
                if (remainder > 0)
                {
                    Console.WriteLine(" " + remainder + " x 1");
